...
@section('content')
    ...
    <div class="container my-3 my-lg-5">
        <div class='row'>
            <div class="col-md-8">
                <div class="post-loop-inner position-relative" style='background-image:url({{Storage::url($event->image)}});'>
                    <div class="post-content" lang="en">
                        <h6 style='color:#FFF;' class=''>
                            {{$event->title}}
                        </h6>
                        <p class="post-date">{{$event->start_date}}</p>
                    </div>
