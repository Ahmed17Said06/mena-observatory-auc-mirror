                        ...
                        <div class="social-share-buttons d-flex flex-column align-items-center mt-5" style="margin-left: 0;">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}"
                                   ...
                                   style="background: #3b5998; font-size: 14px; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; margin-inline-end: 8px; border-radius: 50%; color: white;"></a>
                                
                                <!-- X (Twitter) -->
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}" 
                                   target="_blank" class="fa-brands fa-x-twitter" aria-label="Share on X"
                                   style="background: #000000; font-size: 14px; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; margin-inline-end: 8px; border-radius: 50%; color: white;"></a>
                                ...
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(url()->current()) }}"
                                   ...
                                   style="background: #0077b5; font-size: 14px; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; margin-inline-end: 8px; border-radius: 50%; color: white;"></a>
                                ...
                                <a href="https://api.whatsapp.com/send?text={{ urlencode($blog->title) }}%20{{ urlencode(url()->current()) }}" 
                                   ...
                                   style="background: #25D366; font-size: 14px; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; margin-inline-end: 8px; border-radius: 50%; color: white;"></a>
