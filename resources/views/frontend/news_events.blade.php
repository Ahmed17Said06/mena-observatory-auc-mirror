...
#events_pagination nav:first-child div:first-child, #news_pagination nav:first-child div:first-child{
	display:none;
}
#events_pagination, #news_pagination{
	text-align:center;
}
...
<livewire:events-section wire:key='data2'/>
