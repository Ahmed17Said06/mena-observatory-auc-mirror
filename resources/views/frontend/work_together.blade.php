    ...
    <div class="container-fluid position-relative my-5" style="padding-bottom: 100px">
        ...
        <div class="container p-0">
            <div class='row my-5' style="max-width: 700px; margin: auto">
                ...
                <x-alert-two/>
                <form class="my-4" role="form" method="POST" action="{{ route('post.work.together') }}"
                ...
                <textarea rows="3" name="bio" class="form-control form-control-lg"
                          placeholder="Brief Bio (250-350 words)"
                          aria-label="Brief Bio (250-350 words)" required></textarea>
                    </div>
                    <div class="flex flex-col mb-3">
                        ...
                        <div class="upload-btn">
                            <label for="cv_link">Upload CV
                                <img class="upload-icon"
                                     src="{{ asset("/img/Layer_1 (3).svg") }}">
                            </label>
                            <input type="file" id="cv_link" name="cv_link"
                    ...
                    <div class="flex flex-col mb-3">
                        <div class="upload-btn">
                            <label for="collaboration_link">
                                Upload Collaboration details
                                <img class="upload-icon"
                                     src="{{ asset("/img/Layer_1 (3).svg") }}">
                            </label>
                            <input type="file" id="collaboration_link" name="collaboration_link"
                                   accept=".pdf,.docx,.doc,.ppt,.pptx"
                                   style="opacity: 0;" required>
                        </div>
                    </div>
