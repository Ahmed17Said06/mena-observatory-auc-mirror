...
<header class="container d-none d-lg-block">
    <div class='row' style='height:115px'>
        <div class='col-md-3 align-self-center'>
            <a class="navbar-brand" href="/">
                <img src='/img/logo2.svg' height='45px' style='height:45%;'>
            </a>
        </div>
        <div class='col-md-9'>
    ...
    gap: 12px">
                ...
                <div class="language-switcher">
                    ...
                    @if (++$currentLocaleIndex < $totalLocales) <svg xmlns="http://www.w3.org/2000/svg" width="2"
                        height="17" viewBox="0 0 2 17" fill="none">
            ...
            <div class='row col-12'>
                <nav class="navbar navbar-expand-lg navbar-light"
                    ...
                    <div @if(LaravelLocalization::getCurrentLocale()==='ar' ) dir="rtl" @endif
                        hreflang="{{ getLang() }}" class="collapse navbar-collapse" style='flex-grow:0; margin-left:auto;
    box-shadow: inset 0px -1px 0px #E1E3E5;' id="navbarNav">
                        <ul class="navbar-nav">
                            <li
                                class="nav-item @if(str(Route::current()->getName())->contains('about_us')) active @endif">
                                <a hreflang="{{ getLang() }}" class="nav-link"
                                    href="{{route('about_us')}}">@lang('translation.about-us')
                                    <span class="sr-only">(current)</span></a>
                            </li>
                            <li
                                class="d-flex align-items-center nav-item dropdown @if(str(Route::current()->getName())->contains('regional')) active @endif">
                            ...
                            <li
                                class="nav-item @if(str(Route::current()->getName())->contains('data_repo')) active @endif">
                                <a class="nav-link"
                            ...
                            <li
                                ...
                                <div class="dropdown-content" @if(LaravelLocalization::getCurrentLocale()==='ar' )
                                    ...
                                    <a class="nav-link"
                                        href="{{ route('collaborators') }}">@lang('translation.collaborators')
                                        <span class="sr-only">(current)</span></a>
                                </div>
                            </li>
            ...
            <div class="mobile-menu-content">
                ...
                <div class="nav-menu">
                    ...
                    <div class="language-switcher">
                        ...
                        @endphp
                        @foreach($locales as $localeCode => $properties)
                        <a rel="alternate" @if(LaravelLocalization::getCurrentLocale()===$localeCode) class="active"
