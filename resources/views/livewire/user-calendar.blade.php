<div class="container mt-4">
        ...
        <div class='col-12 py-3'>
            <div class="d-flex justify-content-between">
                ...
                <div class="w-50 d-flex justify-content-end align-items-end">
                        <div style="padding-top: 0px; padding-right: 15px" class="search-box event">
                            <form>
                                <input class="search" type="text" placeholder="Search posts" name="blogs_keywords" wire:keyup="updateSearch" wire:model="search" id='blogs_keywords'>
    ...
    <div @if(!$isMonthView) style="display: none" @endif>
        <div class="calendar-container d-none d-lg-flex flex-lg-row flex-column my-5" >
            @if($eventDetails)
                ...
                <div id="event-details" class="col-lg-3">
                    ...
                    <div class="d-flex">
                        ...
                        <livewire:save-event :eventId="$eventDetails->id" :wire:key="'event'.$eventDetails->id"/>
        ...
        'type' => $event->type,
         'allDay' => true
                ...
                eventContent: function (info) {
                    ...
                    type = (info.event.type == "Online")?  '<span class="event_attendance online"/>':
                        (info.event.type == "Hybrid")?  '<span class="event_attendance hybrid"/>':'<span class="event_attendance in-person"/>'
